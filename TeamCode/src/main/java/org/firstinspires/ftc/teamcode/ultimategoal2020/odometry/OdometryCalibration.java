...
public class OdometryCalibration extends LinearOpMode {
    ...
    String fLName = "fL", fRName = "fR", bRName = "bR", bLName = "bL";
    ...
    public void runOpMode() throws InterruptedException {
        ...
        initHardwareMap(fLName, fRName, bRName, bLName, verticalLeftEncoderName, verticalRightEncoderName, horizontalEncoderName);
    ...
    private void initHardwareMap(String rfName, String rbName, String lfName, String lbName, String vlEncoderName, String vrEncoderName, String hEncoderName){
        robot.fR = hardwareMap.dcMotor.get(rfName);
        robot.bR = hardwareMap.dcMotor.get(rbName);
        robot.fL = hardwareMap.dcMotor.get(lfName);
        robot.bL = hardwareMap.dcMotor.get(lbName);
    ...
    private void setPowerAll(double rf, double rb, double lf, double lb){
        robot.fR.setPower(rf);
        robot.bR.setPower(rb);
        robot.fL.setPower(lf);
        robot.bL.setPower(lb);
    }
