...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double X_MULTIPLIER = 0.5267242861724031 * 0.9532277862648019 * 0.9806530843242914; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 0.4748931109243539 * 1.184626406157297 * 1.0829793956047 * 0.8208074974198429 * 0.9718583622073861; // Multiplier in the Y direction
    ...
    public TwoWheelTrackingLocalizer(HardwareMap hardwareMap, SampleMecanumDrive drive) {
        ...
        parallelEncoder.setDirection(Encoder.Direction.REVERSE); ////unreverse if not working
